  ...
  sections: [
      ...
      subsections: [
        ...
        },
        {
          ...
          blocks: [
            {
              type: "Paragraph",
              content: "This kit serves as the foundation for all Swift activity, from campaigns and creative assets to sales presentations and partnerships. By following its guidelines, every communication will reflect Swift's clarity, connectedness, and focus on outcomes."
            }
          ]
        },
        {
    ...
    // THE GOAL SECTION
    {
      ...
      blocks: [
        {
          type: "Paragraph",
          content: "To establish Swift Innovation as the go-to partner for companies seeking to align strategy, speed, and execution under one roof. First by dominating the mid-market B2B space (manufacturing, technology, services), and then scaling into vertical-specific ecosystems through Agency Direct and White Label channels."
        }
      ]
    },
          ...
          cards: [
            {
              ...
              content: "Silos slow everything down - marketing runs campaigns without dev support, sales works leads without aligned operations, leadership loses clarity. Swift solves this by embedding cross-disciplinary teams into client workflows. Design, marketing, development, and strategy operate as one unit, creating seamless handoffs, faster delivery, and a culture of aligned execution that compounds growth."
            },
            {
              title: "Digital Tools",
              content: "Disconnected platforms create wasted time and unclear results. Swift equips every client with a unified foundation of CRMs, analytics, and automation - the same operational backbone we use ourselves. This structure provides real-time visibility, automates repeatable tasks, and creates scalable infrastructure that supports growth without chaos."
            },
            {
              title: "Market Trends",
              content: "Business is shifting fast: 60% of the workforce will be independent by 2027, 66% of companies outsource, and 73% already hire globally. Swift was built for this future. By embracing independence, distributed expertise, and embedded partnerships, we position clients not just to adapt but to gain an advantage from the new world of work."
            },
            {
              title: "Revenue Streams",
              content: "Sustainable growth requires layered channels. Swift expands revenue through:"
            }
          ]
        },
        {
      ...
      subsections: [
          ...
          blocks: [
            {
              ...
              title: "Scrappy founders running mid-market companies who juggle multiple hats and feel the strain of disconnected teams, tools, and vendors.",
              demographics: "Gen X/Millennial founders; often in manufacturing, tech, or service industries.",
              psychographics: "Ambitious but burned out; values autonomy, quick wins, and partners who \"get it done.\"",
              painPoints: [
            ...
            },
            {
              ...
              title: "Leaders who have been burned by agencies or consultants before and now demand proof, accountability, and outcomes.",
              demographics: "Senior leaders at $10M–$100M companies.",
              psychographics: "Data-driven, expects rigor and reliability; values credibility over creativity alone.",
              painPoints: [
            ...
            },
            {
              ...
              title: "Agency owners and consultants who need to scale capacity but can't afford to hire in-house.",
              demographics: "Agency teams of 5–25, often in design, marketing, or niche tech services.",
              psychographics: "Entrepreneurial, protective of their client relationships, values white-label discretion.",
              painPoints: [
            ...
            },
            {
              ...
              title: "Executives at larger organizations who need embedded support without adding headcount.",
              demographics: "Corporate decision-makers in operations, marketing, or digital transformation.",
              psychographics: "Risk-averse but pragmatic; values proven partners who can navigate enterprise complexity.",
              painPoints: [
        ...
        },
        {
          ...
          blocks: [
            {
              type: "Table",
              headers: ["Category", "NAICS Code", "USA Companies Est.", "Description"],
              rows: [
                ["Pet Retail / Pet Products", "459910", "10,853", "Pet and Pet Supplies Retailers: Retailing pets, pet foods, and pet supplies."],
                ["Pet Care (non-veterinary)", "812910", "32,943", "Pet Care (except Veterinary) Services: Pet grooming, boarding, daycare, walking, sitting, etc."],
                ["Veterinary Services", "541940", "46,350", "Veterinary Services: Practice of veterinary medicine, dentistry, surgery for pets; includes pet hospitals and clinics."],
                ["Pet Food Manufacturing", "311111 and 311119", "153 and 1,797", "Dog and Cat Food Manufacturing and Other Animal Food Manufacturing: For companies producing pet foods."],
                ["Wholesale (Pets & Supplies)", "424990", "3,209", "Other Miscellaneous Nondurable Goods Merchant Wholesalers: Includes wholesalers in pet-related categories."]
              ]
            },
            {
              type: "Table",
              headers: ["Category", "NAICS Code(s)", "Estimated U.S. Companies", "Description"],
              rows: [
                ["Manufacturing", "31-33", "~660,000 establishments", "Manufacturers of goods from machinery to electronics, components, materials (NAICS Association, NAICS Association, Bureau of Labor Statistics)"],
                ["Software & Technology", "541511, 541512", "Part of ~2.49 million in professional, scientific, and technical services (NAICS Association)", "NAICS 541511: Custom Computer Programming Services; 541512: Computer Systems Design"],
                ["Agencies & Consultants", "541611", "Within ~2.49 million in professional, scientific, and technical services (NAICS Association)", "Administrative Management & General Management Consulting"],
                ["Consumer Goods (DTC)", "454110, 454311", "Within broader retail (~1.8 million U.S. retail businesses) (NAICS Association)", "Electronic Shopping/Mail-order houses; Warehouse clubs & supercenters"]
              ]
            }
          ]
        },
        {
          ...
          blocks: [
            {
              type: "Table",
              headers: ["Industry", "Global Companies Est.", "USA Companies Est.", "Description"],
              rows: [
                ["Manufacturing", "1M", "150K", "Electronic Manufacturing, Food Manufacturing, Machinery"],
                ["Software & Technology", "2.6M", "477K", "Software and Information Technology: SaaS"],
                ["Agencies & Consultants", "1M", "232K", "Marketing and Advertising Agencies"],
                ["Consumer Goods (DTC)", "80K", "21K", "Consumer Goods and Consumer Electronics"]
              ]
            }
          ]
        }
      ...
      subsections: [
        ...
        },
        {
          ...
          blocks: [
            {
              type: "Paragraph",
              content: "Help businesses grow without fragmentation by uniting strategy, execution, and technology in one embedded partner - so leaders can focus on vision while Swift delivers momentum."
            }
          ]
        },
        {
          ...
          blocks: [
            {
              type: "Bullets",
              items: [
                [{ text: "Homepage headline: ", bold: true }, { text: "\"Building momentum through connected disciplines.\"" }],
                [{ text: "LinkedIn caption: ", bold: true }, { text: "\"Most agencies sell campaigns. Consultants sell strategy. Dev shops sell code. We bring them together into one embedded system - designed to deliver outcomes.\"" }],
                [{ text: "Twitter/X Post: ", bold: true }, { text: "\"Growth doesn't stall from lack of ideas. It stalls from fragmentation. Swift Innovation removes the silos so execution actually scales.\"" }],
                [{ text: "Sales Deck Slide: ", bold: true }, { text: "\"Products. Support. Platform. Three tracks. One system. Growth without fragmentation.\"" }],
                [{ text: "Google Search Ad: ", bold: true }, { text: "Headline: Outsourced Support + Products | Description: Design, marketing, and development aligned under one roof. Faster outcomes, scalable infrastructure." }],
                [{ text: "Email reassurance: ", bold: true }, { text: "\"Swift isn't another vendor. We embed as part of your team, aligning strategy, execution, and tools to deliver measurable outcomes.\"" }]
              ]
            }
          ]
        },
          ...
          blocks: [
            {
              ...
              items: [
                ...
                { text: "\"Your partner for everything business.\" (generic)", checked: false },
                { text: "\"Solutions made simple.\" (overused, vague)", checked: false },
      ...
      subsections: [
        {
          ...
          blocks: [
            ...
            },
            {
              type: "Paragraph",
              content: [
                { text: "Phase 1: Mid-Market Ownership (Low Competition, High Relevance)", bold: true },
            ...
            },
            {
              type: "Paragraph",
              content: [
                { text: "Phase 2: Category Expansion (Mid Competition, Category Building)", bold: true },
            ...
            },
            {
              type: "Paragraph",
              content: [
                { text: "Phase 3: High-Volume Capture (Broad Market, High Competition)", bold: true },
        ...
        },
        {
          ...
          blocks: [
            {
              type: "Paragraph",
              content: "Swift's blog strategy will position it as the go-to voice for clarity, infrastructure, and execution in the mid-market. Blogs will blend practical education, thought leadership, and credibility to show how connected systems outperform fragmented vendors."
            },
            {
              type: "Heading",
              level: 4,
        ...
        },
        {
          ...
          blocks: [
            ...
            {
              type: "Paragraph",
              content: "Each blog will follow a consistent framework to maximize readability, SEO, and conversion:"
            },
            {
              type: "Bullets",
              items: [
        ...
        },
        {
          ...
          blocks: [
            {
              type: "Paragraph",
              content: "The marketing kit and the Social Program Strategy section provide a clear, actionable framework for creating, writing, and designing organic social content. It is designed for internal creators to produce consistent, on-brand assets quickly."
            },
            {
              type: "Paragraph",
              content: "We need a balanced mix of proof and case storytelling, thought leadership, system how-tos, behind-the-scenes team moments, and partner spotlights aligned to Swift's goals of clarity, momentum, and outcomes."
            },
            {
              type: "Heading",
              level: 4,
            ...
            },
            {
              type: "Bullets",
              items: [
                [{ text: "Summary", bold: true }, { text: ", show a before-after of a fragmented stack replaced by Swift's connected system." }],
                [{ text: "Copy", bold: true }, { text: ", Most teams stall due to silos. We embed across disciplines so strategy, speed, and execution move together. See how a connected stack turned activity into outcomes, then let's plan your roadmap." }],
                [{ text: "Hashtags", bold: true }, { text: ", #SwiftInnovation #GrowthWithoutFragmentation #B2BMarketing #OpsEnablement #CRM #Analytics #AgencyPartners #MidMarket" }],
                [{ text: "Design Goal", bold: true }, { text: ", side-by-side grid, simple system diagram, bold headline, minimal copy, clear CTA to swiftinnovation.io." }],
                [{ text: "Frequency", bold: true }, { text: ", one to two times per week." }]
              ]
            },
            {
              type: "Heading",
            ...
            },
            {
              type: "Bullets",
              items: [
                [{ text: "Summary", bold: true }, { text: ", day-in-the-life sequence showing design, marketing, and dev handoffs." }],
                [{ text: "Copy", bold: true }, { text: ", From brief to live, our teams move as one. Tap through the handoff trail, then grab the playbook link at the end." }],
                [{ text: "Hashtags", bold: true }, { text: ", #TeamInAction #SwiftInnovation #DesignToDev #B2BOperations #Workflow #Execution" }],
                [{ text: "Design Goal", bold: true }, { text: ", quick storyboard panels, captioned steps, legible typography, link sticker to playbook on site." }],
                [{ text: "Frequency", bold: true }, { text: ", two to three sequences per week." }]
              ]
            },
            {
              type: "Heading",
            ...
            },
            {
              type: "Bullets",
              items: [
                [{ text: "Summary", bold: true }, { text: ", 30 to 45 second how-to breaking down a CRM or analytics setup step." }],
                [{ text: "Copy", bold: true }, { text: ", Five minutes to better visibility. Here is how we map events so leaders get real-time answers. Watch, then save for your next build." }],
                [{ text: "Hashtags", bold: true }, { text: ", #SwiftInnovation #CRMSetup #Analytics #HowTo #B2BGrowth #Operations" }],
                [{ text: "Design Goal", bold: true }, { text: ", tight screen capture with callouts, large subtitles, clear hook, end card with URL." }],
                [{ text: "Frequency", bold: true }, { text: ", one to two per month." }]
              ]
            },
            {
              type: "Heading",
            ...
            },
            {
              type: "Bullets",
              items: [
                [{ text: "Summary", bold: true }, { text: ", 60 to 120 second founder or operator insight on outcomes over hours." }],
                [{ text: "Copy", bold: true }, { text: ", Strategy without delivery stalls growth. Here is how embedded teams convert plans into measurable outcomes. See the full breakdown on our site." }],
                [{ text: "Hashtags", bold: true }, { text: ", #SwiftInnovation #OutcomesOverHours #Leadership #GrowthStrategy #EmbeddedTeams" }],
                [{ text: "Design Goal", bold: true }, { text: ", clean framing, lower-third headline, crisp audio, captioned for silent viewing, end slate with CTA." }],
                [{ text: "Frequency", bold: true }, { text: ", one to two per month." }]
              ]
            },
            {
            ...
            },
            {
              type: "Bullets",
              items: [
                [{ text: "Summary", bold: true }, { text: ", partner spotlight featuring an agency's white-label win with Swift behind the scenes." }],
                [{ text: "Copy", bold: true }, { text: ", Capacity without overhead. This partner scaled delivery while protecting margins, and their client saw clearer execution. Want a discreet extension of your team, let's talk." }],
                [{ text: "Hashtags", bold: true }, { text: ", #SwiftInnovation #WhiteLabel #AgencyPartners #DeliveryAtScale #B2BCreative #DevSupport" }],
                [{ text: "Design Goal", bold: true }, { text: ", partner logo lockup with permission, single stat or quote if approved, neutral backdrop, clear attribution." }],
                [{ text: "Frequency", bold: true }, { text: ", one to two times per month." }]
              ]
            },
            {
              type: "Heading",
            ...
            {
              type: "Paragraph",
              content: "Weekly rhythm aligns to the kit, three to five posts across LinkedIn, Instagram, and Facebook, plus two to three short-form videos per month and two to three thought leadership posts per month. Rotate formats to balance proof, thought leadership, how-tos, behind-the-scenes, and partner spotlights."
            }
          ]
        }
      ]
    ...
    // LANDING PAGE STRATEGY SECTION
    {
      ...
      blocks: [
        {
          type: "Paragraph",
          content: "Landing pages emphasize clarity, momentum, and outcomes-positioning Swift as the embedded partner that delivers growth without fragmentation."
        },
        {
          type: "Heading",
          level: 3,
        ...
        },
        {
          type: "Bullets",
          items: [
            [{ text: "CRM Landing Page:", bold: true }, { text: " CTA = Book Appointment" }],
            [{ text: "CRM Funnel Page (Event or Webinar):", bold: true }, { text: " CTA = Register for In-Person and/ Online. Funnel Pages are 2-steps (1st step = lander with CTA, 2nd step is Acceptance of Registration)" }],
            [{ text: "Website Landing Page:", bold: true }, { text: " CTA = Contact Us" }]
          ]
        }
      ]
    },
      ...
      blocks: [
        {
          ...
          items: [
            [
              ...
              { text: "Outsourcing Statistics: Key Facts and Trends", italic: true },
              { text: ". Retrieved from " },
              { text: "https://www.demandsage.com/outsourcing-statistics/", link: "https://www.demandsage.com/outsourcing-statistics/" }
            ],
            [
              { text: "Wired. (2023). " },
              { text: "High-Value Freelancers Are Keeping the Wheels of Tech Turning", italic: true },
              { text: ". Retrieved from " },
              { text: "https://www.wired.com/story/high-value-freelancers-are-keeping-the-wheels-of-tech-turning/", link: "https://www.wired.com/story/high-value-freelancers-are-keeping-the-wheels-of-tech-turning/" }
            ],
            [
              { text: "Wikipedia. (2025). " },
              { text: "Business process outsourcing", italic: true },
              { text: ". Retrieved from " },
              { text: "https://en.wikipedia.org/wiki/Business_process_outsourcing", link: "https://en.wikipedia.org/wiki/Business_process_outsourcing" }
            ],
            [
              { text: "Shekhar, S. (2022). " },
              { text: "Outsourcing for Innovation and Flexibility", italic: true },
              { text: ". arXiv. Retrieved from " },
              { text: "https://arxiv.org/abs/2206.00982", link: "https://arxiv.org/abs/2206.00982" }
            ],
            [
              { text: "SICCODE.com. (n.d.). " },
              { text: "NAICS Code 459910 – Pet and Pet Supplies Retailers", italic: true },
              { text: ". Retrieved 8-24-25, from siccode.com website: " },
              { text: "https://siccode.com/naics-code/459910/pet-pet-supplies-retailers", link: "https://siccode.com/naics-code/459910/pet-pet-supplies-retailers" }
            ]
          ]
        }
      ]
